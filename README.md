...
### Cleaning and processing tweets to decipher whether a tweet has positive or negative market sentiment. Then using the right "trigger condition"(buy-sell algoithm used) to complete a trade of bitcoin on this Binance platform.
